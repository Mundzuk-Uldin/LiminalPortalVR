...
namespace Portals {
    ...
    public class RigidbodyCharacterController : MonoBehaviour {
        ...
        private void ApplyDrag() {
            Vector3 horizontalVelocity = Vector3.ProjectOnPlane(_rigidbody.linearVelocity, this.UpVector);
            Vector3 verticalVelocity = _rigidbody.linearVelocity - horizontalVelocity;
