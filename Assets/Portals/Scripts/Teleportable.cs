...
namespace Portals {
    ...
    public class Teleportable : MonoBehaviour {
        ...
        private void SweepTest() {
            ...
            RaycastHit[] hits = _rigidbody.SweepTestAll(_rigidbody.linearVelocity, _rigidbody.linearVelocity.magnitude * Time.fixedDeltaTime, QueryTriggerInteraction.Collide);
        ...
        private void DoClonePhysicsStep() {
            foreach (KeyValuePair<Portal, PortalContext> kvp in _contextByPortal) {
                ...
                Vector3 slaveDeltaVelocity = clone._rigidbody.linearVelocity - clone._rigidbodyLastTick.velocity;
                Vector3 masterDeltaVelocity = _rigidbody.linearVelocity - _rigidbodyLastTick.velocity;
                ...
                _rigidbody.linearVelocity += velocityTransfer;
        ...
        private void FixedUpdate() {
            ...
            foreach (KeyValuePair<Portal, PortalContext> kvp in _contextByPortal) {
                ...
                clone._rigidbody.linearVelocity = portal.TeleportVector(_rigidbody.linearVelocity);
        ...
        private void Teleport(Portal portal) {
            ...
            if (_rigidbody && !_rigidbody.isKinematic) {
                _rigidbody.linearVelocity = portal.TeleportVector(_rigidbody.linearVelocity);
        ...
        private void SaveRigidbodyInfo() {
            if (_rigidbody) {
                ...
                _rigidbodyLastTick.velocity = _rigidbody.linearVelocity;
